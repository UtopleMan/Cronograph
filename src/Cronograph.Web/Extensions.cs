...
namespace Cronograph.Web;

public static class Extensions
{
    public static IEndpointRouteBuilder UseCronographUI2(this IEndpointRouteBuilder endpoints)
    {
        //endpoints.MapFallbackToFile("BlocklyAutomation/{**:nonfile}", "BlocklyAutomation/index.html");
        endpoints.Map("cronograph/{**:nonfile}", async ctx =>
        {
            var dir = FileProvider.GetDirectoryContents("wwwroot").ToArray();
    ...
    public static void UseCronographUI(this IApplicationBuilder appBuilder, IWebHostEnvironment environment, bool registerStaticAndDefaultFiles = true)
    {
